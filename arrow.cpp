...
//    qreal arrowSize = 20;
//    list.clear();
//    if((myStartItem->GetLocation().y()-100-arrowSize>=myEndItem->GetLocation().y()||myEndItem->GetLocation().y()>=myStartItem->GetLocation().y()+100+arrowSize)&&
//       (myStartItem->GetLocation().x()-100-arrowSize>=myEndItem->GetLocation().x()||myEndItem->GetLocation().x()>=myStartItem->GetLocation().x()+100+arrowSize))
//    {
...
//    else if(myStartItem->GetLocation().y()-100-arrowSize<myEndItem->GetLocation().y()&&myEndItem->GetLocation().y()<myStartItem->GetLocation().y()+100+arrowSize){
...
//        arrowHead << ql->p1() << arrowP1 << arrowP2;
//    }
//    else if(myStartItem->GetLocation().x()-100-arrowSize<myEndItem->GetLocation().x()&&myEndItem->GetLocation().x()<myStartItem->GetLocation().x()+100+arrowSize){
